...
|-----------|------------------|-------------------------------------|--------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------|
| EPIC-001  | US-001           | Página Principal Atractiva           | Como usuario, quiero ver una página principal atractiva sobre Greenhouse. | 1. En Escenario 1, Carlos P. visita la página principal y debe ver imágenes de alta calidad. 2. En Escenario 2, Carlos P. accede a la página, y la información debe ser clara y concisa. 3. En Escenario 3, Carlos P. abre la página, y esta debe ser responsive.  |
| EPIC-002  | US-002           | Promociones y Ofertas               | Como usuario, deseo encontrar información actualizada sobre promociones.  | 1. En Escenario 1, Carlos P. busca promociones y debe ver las promociones vigentes con imágenes y detalles. 2. En Escenario 2, Carlos P. busca promociones, y las fechas de las promociones deben ser visibles y actualizadas regularmente. 3. En Escenario 3, Carlos P. busca promociones, y los precios de las bebidas en promoción deben ser claros.      |
| EPIC-003  | US-003           | Registro de Usuarios Nuevos         | Como usuario nuevo, quiero registrarme y obtener un descuento.           | 1. En Escenario 1, Carlos P. se registra y debe obtener un descuento que se aplica automáticamente. 2. En Escenario 2, Carlos P. completa el registro y debe recibir un correo de confirmación con el código de descuento. 3. En Escenario 3, Carlos P. se registra y debe recibir un correo de confirmación con el código de descuento. |
| EPIC-004  | US-004           | Exploración de Eventos Pasados       | Como usuario interesado en eventos, quiero ver imágenes de eventos pasados.                    | 1. En Escenario 1, Carlos P. explora eventos pasados y debe ver imágenes atractivas de eventos anteriores. 2. En Escenario 2, Carlos P. busca eventos anteriores y debe encontrar descripciones detalladas de los eventos. 3. En Escenario 3, Carlos P. explora eventos pasados y debe ver eventos categorizados.     |
| EPIC-005  | US-005           | Testimonios de Clientes             | Como usuario, deseo leer testimonios de clientes satisfechos.           | 1. En Escenario 1, Carlos P. busca testimonios y debe ver testimonios reales de clientes con nombres y fechas. 2. En Escenario 2, Carlos P. lee testimonios y debe encontrar comentarios positivos sobre la experiencia en Greenhouse. 3. En Escenario 3, Carlos P. accede a testimonios y debe ver testimonios que los clientes pueden calificar como útiles o no útiles.                                |
| EPIC-006  | US-006           | Información de Contacto              | Como usuario, quiero encontrar información de contacto clara.            | 1. En Escenario 1, Carlos P. busca información de contacto y debe encontrar un formulario de contacto y un número de teléfono visible. 2. En Escenario 2, Carlos P. envía un mensaje desde el formulario de contacto y debe recibir una confirmación por correo electrónico. 3. En Escenario 3, Carlos P. hace clic en el número de teléfono y debe poder realizar llamadas directas. |
| EPIC-007  | US-007           | Exploración del Menú                | Como usuario, deseo ver el menú de bebidas y alimentos.                 | 1. En Escenario 1, Carlos P. explora el menú y debe ver una sección de menú con imágenes atractivas. 2. En Escenario 2, Carlos P. busca el menú y los precios y opciones de bebidas y alimentos deben ser claramente visibles. 3. En Escenario 3, Carlos P. filtra los elementos del menú y debe poder hacerlo por categorías (bebidas, alimentos, postres, etc.). |
| EPIC-008  | US-008           | Ubicación en el Mapa                | Como usuario, quiero un mapa interactivo para encontrar Greenhouse.     | 1. En Escenario 1, Carlos P. busca la ubicación y debe ver un mapa con la ubicación exacta de Greenhouse. 2. En Escenario 2, Carlos P. busca direcciones y debe poder obtenerlas desde su ubicación actual. 3. En Escenario 3, Carlos P. accede al mapa y la ubicación de Greenhouse debe actualizarse automáticamente si hay cambios.              |
| EPIC-009  | US-009           | Noticias y Eventos Futuros          | Como usuario, quiero ver noticias y eventos futuros.                     | 1. En Escenario 1, Carlos P. busca noticias y eventos y debe encontrar una sección actualizada regularmente. 2. En Escenario 2, Carlos P. hace clic en una noticia y debe poder obtener más detalles sobre ella. 3. En Escenario 3, Carlos P. explora eventos futuros y debe ver eventos marcados con fechas y descripciones. |
| EPIC-010  | US-010           | Accesibilidad Móvil                 | Como usuario de dispositivos móviles, quiero una página responsive.     | 1. En Escenario 1, Carlos P. accede desde su dispositivo móvil y la página se adapta a su pantalla. 2. En Escenario 2, Carlos P. visita la página desde su móvil y todos los elementos son interactuables. 3. En Escenario 3, Carlos P. navega desde su tablet y la experiencia es intuitiva y cómoda. |
| EPIC-011  | US-011           | Exploración de Fechas Especiales    | Como usuario, deseo encontrar información sobre ofertas en fechas especiales.     | 1. En Escenario 1, Carlos P. busca ofertas en fechas especiales y debe ver promociones específicas con imágenes y detalles. 2. En Escenario 2, Carlos P. busca promociones para eventos especiales y las fechas y detalles se actualizan automáticamente según la temporada o evento. 3. En Escenario 3, Carlos P. encuentra una promoción especial y debe poder compartirla en redes sociales. |
| EPIC-012  | US-012           | Sistema de Gestión de Inventarios    | Como usuario, deseo un sistema de gestión de inventarios.               | 1. En Escenario 1, Carlos P. busca productos y siempre ve la disponibilidad en tiempo real. 2. En Escenario 2, Carlos P. busca promociones y estas se basan en la disponibilidad de productos y se actualizan automáticamente. 3. En Escenario 3, Carlos P. compra un producto y recibe notificaciones sobre productos agotados o en oferta. |
| EPIC-013  | US-013           | Experiencia en Dispositivos Móviles  | Como usuario, quiero una experiencia fluida en dispositivos móviles.   | 1. En Escenario 1, Carlos P. navega desde su dispositivo móvil y la página es responsive y se ajusta a su pantalla. 2. En Escenario 2, Carlos P. explora la página en su móvil y todos los elementos se ajustan de manera óptima. 3. En Escenario 3, Carlos P. navega desde su tablet y la navegación táctil es suave y se proporciona un menú de navegación móvil. |
| EPIC-014  | US-014           | Exploración de Testimonios           | Como usuario, deseo encontrar testimonios de clientes satisfechos.    | 1. En Escenario 1, Carlos P. busca testimonios y debe ver testimonios verificables con comentarios positivos. 2. En Escenario 2, Carlos P. lee testimonios y debe encontrar testimonios con nombres y fechas. 3. En Escenario 3, Carlos P. accede a testimonios y debe poder enviar sus propios testimonios desde la página principal. |
| EPIC-015  | US-015           | Información de Reservas              | Como usuario, quiero poder realizar reservas de mesas desde la página principal.         | 1. En Escenario 1, Carlos P. desea reservar una mesa y la página ofrece un formulario de reserva de mesas con opciones de fecha y hora. 2. En Escenario 2, Carlos P. quiere hacer una reserva y recibe una confirmación de reserva por correo electrónico y un recordatorio antes de la fecha de reserva. 3. En Escenario 3, Carlos P. decide reservar una mesa y puede modificar o cancelar su reserva desde la página principal. |
