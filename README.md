...
<tr>
  <th style="border: 1px solid #dddddd; padding: 8px; text-align: center;">Location</th>
  <td style="border: 1px solid #dddddd; padding: 8px; text-align: center;">El lugar de reunión fue en la plataforma de videoconferencia virtual <strong>“Google Meet”</strong>, de lo cual se desarrolló para conversar en relación a los deberes que cada uno debe desarrollar para este <em>sprint 4.</em> -.</td>
</tr>
<tr>
  <th style="border: 1px solid #dddddd; padding: 8px; text-align: center;">Prepared By</th>
  <td style="border: 1px solid #dddddd; padding: 8px; text-align: center;">Huamani Sánchez, José Diego</td>
...
Entrega del cuarto sprint

En la entrega del cuarto sprint, se completó la implementación de la página de destino, la aplicación web y el back-end. Todos los requisitos de los usuarios fueron satisfechos.

Landing page:

La página de destino se desplegó en GitHub Pages después de fusionar la rama "develop" con la rama principal. Este proceso actualizó la implementación de la página de destino.
...
La aplicación web se desplegó en Netlify después de realizar un merge en la rama principal. Netlify detectó los cambios y realizó un nuevo despliegue.
